[
    {
        ...
        "data":[
            ...
            },
            {
                ...
                "rule":{
                    "首页规则":'var 列表=getVar("源码").replace(/\\s+/g,"").match(/\\{"lUid".+?sRecommendTagName.+?\\}/g);var 标题规则=".json(sRoomName)";var 地址规则=".c(/).json(lProfileRoom)";var 图片规则=".json(sScreenshot)";var 简介规则=".json(sIntroduction)";var NEXTPAGE="";var PREPAGE="";',
