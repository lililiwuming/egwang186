[
    {
        ...
        "data":[
            ...
            },
            {
                ...
                "rule":{
                    "首页规则":'var 列表=e2Arr(getVar("源码"),".get(ul.img-list li)");var 标题规则=".get(div.name a).t()";var 地址规则=".get(div.name a).a(href)";var 图片规则=".get(img).a(data-original)";var 简介规则=".t()";var 图片底部规则="";var 左上规则="";var 右上规则="";var NEXTPAGE="";var PREPAGE="";',
                    ...
                    "分类规则":'var 列表=e2Arr(getVar("源码"),".get(ul.img-list li)");var 标题规则=".get(div.name a).t()";var 地址规则=".get(div.name a).a(href)";var 图片规则=".get(img).a(data-original)";var 简介规则=".t()";var 图片底部规则="";var 左上规则="";var 右上规则="";var NEXTPAGE="";var PREPAGE="";',
