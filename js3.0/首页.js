[
    {
        ...
        "data":[
            ...
            },
            {
                ...
                "rule":{
                    "首页规则":'var 列表=e2Arr(getVar("源码").replace(/\\s+/g,""),".z(\\\\{\\"lUid\\"[^\\{]+?sRecommendTagName.+?\\\\})");var 标题规则=".json(sRoomName)";var 地址规则=".c(/).json(lProfileRoom)";var 图片规则=".json(sScreenshot)";var 简介规则=".json(sIntroduction)";var NEXTPAGE="";var PREPAGE="";',
