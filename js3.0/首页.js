        ...
        "data":[
            ...
            },
            {
                ...
                "rule":{
                    ...
                    "免嗅探规则":'var code=getHttp(getVar("url"));var playurl=code.match(/url:.*?\'(.+?)\'/)[1];JSON.stringify({url:playurl+"?type=.m3u8"});'
                }
            }
        ]
    },
