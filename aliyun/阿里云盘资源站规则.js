...
{"data":[{
    ...
    "title":"TG频道订阅",
    "rule":{
        "分类":'var a="云盘资源发布$https://tx.me/s/sharealiyun#PN#$$云盘盘$https://tx.me/s/yunpanpan#PN#$$云盘影视共享$https://tx.me/s/alypysgx#PN#$$V云盘$https://tx.me/s/aliyun69#PN#$$云盘资源共享$https://tx.me/s/aliyunziyuanfenxiang#PN#$$WAYOU资源每日更新$https://tx.me/s/WaYouZiYuan#PN#";var a=a.split("$$");var items=[];for(var i in a){var title=a[i].split("$")[0];var url=a[i].split("$")[1];items.push({title:title,url:url});}JSON.stringify(items);',
