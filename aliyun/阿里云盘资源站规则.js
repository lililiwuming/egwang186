...
{"data":[{
    ...
    "img":"",
    "rule":{
        "分类":"影视,https://pan.3636360.com/api/v3/thread.list?perPage=10&page=#PN#&filter[categoryids][0]=1&filter[essence]=0&filter[attention]=0&filter[sort]=1&scope=0$$动漫,https://pan.3636360.com/api/v3/thread.list?perPage=10&page=#PN#&filter[categoryids][0]=7&filter[essence]=0&filter[attention]=0&filter[sort]=1&scope=0$$音乐,https://pan.3636360.com/api/v3/thread.list?perPage=10&page=#PN#&filter[categoryids][0]=2&filter[essence]=0&filter[attention]=0&filter[sort]=1&scope=0",
