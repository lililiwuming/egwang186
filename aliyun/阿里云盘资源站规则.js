...
{"data":[
{
    "title":"阿里小纸条",
    "rule":{
        "分类":'var a=JSON.parse(getHttp(JSON.stringify({url:"https://gitcafe.net/alipaper/home.json"}))).data;for(var i in a){a[i].title=a[i].info.name+a[i].info.cat_num;a[i].url="https://gitcafe.net/alipaper/data/"+a[i].info.code+".json";}JSON.stringify(a);',
