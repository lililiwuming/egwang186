...
if(getVar("url").indexOf("$$")!=-1){
    ...
    var resp=JZ(JSON.stringify({url:JSON.parse(code).download_url,redirect:false,head:{"Referer":"https://www.aliyundrive.com/"}}));
        ...
        JSON.stringify([{name:"原始文件播放",url:resp.head.location,head:{"User-Agent":"Mozilla/5.0","Connection":"Keep-Alive","Accept-Encoding":"identity","Referer":"https://www.aliyundrive.com/"}},{name:"转码m3u8可投屏",url:转码链接,head:{"Referer":"https://www.aliyundrive.com/"}}]);
    }
    }
}else{
var cm=android.webkit.CookieManager.getInstance();
...
alert("请重新登陆阿里云盘网页");
    ...
    JSON.stringify([{name:"原始文件播放",url:u,head:{"User-Agent":"Mozilla/5.0","Connection":"Keep-Alive","Accept-Encoding":"identity","Referer":"https://www.aliyundrive.com/"}},{name:"转码m3u8可投屏",url:转码链接,head:{"Referer":"https://www.aliyundrive.com/"}}]);
}
######文档预览8
var cm=android.webkit.CookieManager.getInstance();
    var ALICOOKIE=cm.getCookie("www.aliyundrive.com");
